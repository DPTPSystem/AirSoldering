...
/*#define DATA_DIR_RD()    TRISD = 0xF0;
#define DATA_DIR_WR()    TRISD = 0x00;
#define OUTPUT_DATA(x) {LATD = (LATD & 0x0F) | x;}*/
...
#define OUTPUT_DATA(x) {LATD = (LATD & 0x0F) | x;} //4 alsó bit magas szintre állítva
